...
→ Open the Customer Intelligence Platform
...
Who are my customers? — Segment them by behaviour
Which customers are about to leave? — Score churn risk per customer with a binary decision
What does a new customer look like? — Predict segment and churn risk in real time
How is the business performing? — Track revenue, products, and geography in a live KPI dashboard
What should leadership do about it? — Automated health scoring, win-back simulation, and strategic action playbook
...
Selowa Mphadi John Data Science Practitioner (Workplace-Based Learning) | Isazi Consulting × Mindworx Academy BSc Mathematical Sciences (Statistics & Operations Research) — University of Limpopo
